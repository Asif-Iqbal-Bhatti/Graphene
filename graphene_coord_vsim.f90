...
! Specify lattice vectors (could also read in file)
 ...
 OPEN (UNIT = 1, FILE = "grapvsim.ascii", STATUS = "replace")
   write(1,*) '#Graphene flake'
   write(1,'(3(2x,F12.6))') n(1)*vec(1,1),    n(2)*vec(1,2),    n(2)*vec(2,2)
   write(1,'(3(2x,F12.6))') n(3)*vec(2,3),    n(3)*vec(2,3),    n(3)*vec(3,3)
   write(1,*)
   write(1,*)
  do ix = 1, n(1)
